...
# Add SAM-HQ directory to path for absolute imports
sam_hq_dir = os.path.dirname(os.path.abspath(__file__))
if sam_hq_dir not in sys.path:
    sys.path.insert(0, sam_hq_dir)

# Import from modeling directory using absolute imports
